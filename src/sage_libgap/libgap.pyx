...
:class:`~sage_libgap.element.GapElement` instances) and use it to
...
You can usually use the :meth:`~sage_libgap.element.GapElement.sage`
...
equivalent::
    ...
    sage: libgap.eval('5/3 + 7*E(3)').sage()                                            # needs sage_libgap.rings.number_field
    7*zeta3 + 5/3
...
#. The GAP containers ``List`` and ``rec`` are converted to Sage
   ...
   :meth:`~sage_libgap.element.GapElement.sage` method is applied
...
:class:`~sage_libgap.element.GapElement`. The other GAP container
...
from sage_libgap.element cimport *

from sage_libgap.cpython.string cimport str_to_bytes
from sage_libgap.rings.integer_ring import ZZ
from sage_libgap.misc.cachefunc import cached_method
from sage_libgap.misc.randstate import current_randstate
...
class Gap:
    ...
    def _coerce_map_from_(self, S):
        ...
        See :mod:`sage_libgap.structure.parent`.

        EXAMPLES::

            sage: libgap.has_coerce_map_from(ZZ)
            True
            sage: libgap.has_coerce_map_from(CyclotomicField(5)['x','y'])               # needs sage_libgap.rings.number_field
            True
        """
        return True
    ...
    def _construct_matrix(self, M):
        ...
        We gracefully handle the case that the conversion fails (:trac:`18039`)::
            ...
            sage: F.<a> = GF(9, modulus="first_lexicographic")                          # needs sage_libgap.rings.finite_rings
            sage: libgap(Matrix(F, [[a]]))                                              # needs sage_libgap.rings.finite_rings
    ...
    def function_factory(self, function_name):
        ...
        A function wrapper
        :class:`~sage_libgap.element.GapElement_Function` for the
    ...
    def get_global(self, variable):
        ...
        A :class:`~sage_libgap.element.GapElement` wrapping the GAP
    ...
    def global_context(self, variable, value):
        ...
        EXAMPLES::
            ...
            1
        """
        from sage_libgap.context_managers import GlobalVariableContext
        initialize()
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: type(libgap)
            <class 'sage_libgap.misc.lazy_import.LazyImport'>
            sage: type(libgap._get_object())
            <class 'sage_libgap.libgap.Gap'>
        """
        pass
    ...
    def __dir__(self):
        ...
        EXAMPLES::
           ...
           True
        """
        from sage_libgap.gap_globals import common_gap_globals
    ...
    def show(self):
        ...
        GAP objects held by Sage as :class:`~sage_libgap.element.GapElement`
        instances.
