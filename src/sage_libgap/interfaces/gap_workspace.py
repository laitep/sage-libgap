...
import hashlib
import subprocess
from sage_libgap.env import DOT_SAGE, HOSTNAME, GAP_ROOT_PATHS
...
def gap_workspace_file(system="gap", name="workspace", dir=None):
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.interfaces.gap_workspace import gap_workspace_file
        sage: gap_workspace_file("foo", "bar", "/somewhere")
        '/somewhere/foo-bar-...'

    TESTS::

        sage: from sage_libgap.env import DOT_SAGE
    ...
    Check that the name generated is independent of the session::
        ...
        sage: import sys
        sage: cmd = 'import sage.all, sage_libgap.interfaces.gap_workspace; print(sage_libgap.interfaces.gap_workspace.gap_workspace_file())'
...
def prepare_workspace_dir(dir=None):
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.interfaces.gap_workspace import prepare_workspace_dir
