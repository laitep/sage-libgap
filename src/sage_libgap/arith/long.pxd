...
# sage.doctest: needs sage_libgap.misc.cython
r"""
...
from sage_libgap.cpython.pycore_long cimport (
    ob_digit, _PyLong_IsNegative, _PyLong_DigitCount)

from sage_libgap.libs.gmp.mpz cimport mpz_fits_slong_p, mpz_get_si
from sage_libgap.rings.integer_fake cimport is_Integer, Integer_AS_MPZ
...
cdef inline bint integer_check_long(x, long* value, int* err) except -1:
    ...
    We create a pure Python wrapper of this function::
        ...
        sage: cython('''
        ....: from sage_libgap.arith.long cimport *
        ....: from sage_libgap.rings.integer cimport smallInteger
        ....: def check_long(x):
        ....:     cdef long value
        ....:     cdef int err
...
cdef inline bint is_small_python_int(obj) noexcept:
    ...
    EXAMPLES::
        ...
        sage: cython('''
        ....: from sage_libgap.arith.long cimport is_small_python_int
