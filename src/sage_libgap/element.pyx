...
:mod:`~sage_libgap.libgap` module documentation.
"""
# ****************************************************************************
...
from sage_libgap.gap_includes cimport *
from sage_libgap.util cimport *
from sage_libgap.util import GAPError
from sage_libgap.cpython.string cimport str_to_bytes, char_to_str
from sage_libgap.rings.integer_ring import ZZ
from sage_libgap.rings.rational_field import QQ
from sage_libgap.rings.real_double import RDF
...
cdef GapElement make_any_gap_element(parent, Obj obj) noexcept:
    ...
    TESTS::
        ...
        "c"
        sage: type(x)
        <class 'sage_libgap.element.GapElement_String'>
...
cdef GapElement make_GapElement(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        0
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Integer'>
...
cdef class GapElement(Element):
    ...
    def __init__(self):
        ...
        TESTS::
            ...
            sage: from sage_libgap.element import GapElement
            sage: GapElement()
            Traceback (most recent call last):
            ...
    ...
    def __reduce__(self):
        ...
        ``sage_libgap.interfaces.interface.Interface._reduce``, though for a fallback
    ...
    def __contains__(self, other):
        ...
        """
        from sage_libgap.libgap import libgap; GAP_IN = libgap.eval(r'\in')
    ...
    def __dir__(self):
        ...
        EXAMPLES::
            ...
            True
        """
        from sage_libgap.operations import OperationInspector
...
cdef class GapElement_Integer(GapElement):
    ...
    def sage(self, ring=None):
        ...
        if self.is_C_int():
            ...
            # (see sage_libgap.libs.gmp.pylong)
...
cdef GapElement_Float make_GapElement_Float(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        123.5
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Float'>
    """
...
cdef GapElement_IntegerMod make_GapElement_IntegerMod(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        ZmodnZObj( 13, 123 )
        sage: type(_)
        <class 'sage_libgap.element.GapElement_IntegerMod'>
    """
...
cdef GapElement_FiniteField make_GapElement_FiniteField(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        Z(5)^2
        sage: type(_)
        <class 'sage_libgap.element.GapElement_FiniteField'>
    """
...
cdef class GapElement_FiniteField(GapElement):
    ...
    def sage(self, ring=None, var='a'):
        ...
        :meth:`~sage_libgap.rings.finite_rings.finite_field_prime_modn.multiplicative_generator`.
        ...
        if ring is None:
            from sage_libgap.rings.finite_rings.finite_field_constructor import GF
...
cdef GapElement_Cyclotomic make_GapElement_Cyclotomic(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        E(3)
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Cyclotomic'>
    """
...
cdef class GapElement_Cyclotomic(GapElement):
    ...
    def sage(self, ring=None):
        ...
        if ring is None:
            ...
            from sage_libgap.rings.number_field.number_field import CyclotomicField
...
cdef GapElement_Rational make_GapElement_Rational(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        41/152
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Rational'>
    """
...
cdef GapElement_Ring make_GapElement_Ring(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        GF(5)
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Ring'>
    """
...
cdef class GapElement_Ring(GapElement):
    ...
    def ring_polynomial(self):
        ...
        from sage_libgap.rings.polynomial.polynomial_ring_constructor import PolynomialRing
...
cdef GapElement_Boolean make_GapElement_Boolean(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        true
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Boolean'>
    """
...
cdef class GapElement_Boolean(GapElement):
    ...
    def __bool__(self):
        ...
        EXAMPLES::
            ...
            true <class 'sage_libgap.element.GapElement_Boolean'>

            sage: for x in gap_bool:
            ....:     if not x:     # this calls __bool__
            ....:         print("{} {}".format( x, type(x)))
            false <class 'sage_libgap.element.GapElement_Boolean'>
            fail <class 'sage_libgap.element.GapElement_Boolean'>
        """
...
cdef GapElement_Function make_GapElement_Function(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Function'>
    """
...
cdef class GapElement_Function(GapElement):
    ...
    def __call__(self, *args):
        ...
        Not every ``GapElement`` is callable::
            ...
            Traceback (most recent call last):
            ...
            TypeError: 'sage_libgap.element.GapElement_Integer' object is not callable
    ...
    def _instancedoc_(self):
        ...
        """
        libgap = self.parent()
        from sage_libgap.interfaces.gap import gap
...
cdef GapElement_MethodProxy make_GapElement_MethodProxy(parent, Obj function, GapElement base_object) noexcept:
    ...
    EXAMPLES::
        ...
        sage: lst = libgap([])
        sage: type( lst.Add )
        <class 'sage_libgap.element.GapElement_MethodProxy'>
    """
...
cdef GapElement_List make_GapElement_List(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        [ 0, 2, 3 ]
        sage: type(_)
        <class 'sage_libgap.element.GapElement_List'>
    """
...
cdef GapElement_Permutation make_GapElement_Permutation(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        (1,3,2)(4,5,8)
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Permutation'>
    """
...
cdef GapElement_Record make_GapElement_Record(parent, Obj obj) noexcept:
    ...
    EXAMPLES::
        ...
        rec( a := 0, b := 2, c := 3 )
        sage: type(_)
        <class 'sage_libgap.element.GapElement_Record'>
    """
...
cdef class GapElement_Record(GapElement):
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: type(iter)
            <class 'sage_libgap.element.GapElement_RecordIterator'>
            sage: sorted(rec)
            [('a', 123), ('b', 456)]
        """
