...
# Modified version of sage_libgap.structure.sage_object for sage_libgap

r"""
Abstract base class for Sage objects
"""

from sage_libgap.misc.persist import _base_dumps, _base_save
...
cdef class SageObject:
    ...
    def rename(self, x=None):
        ...
        Real numbers are not Python classes, so rename is not supported::
            ...
            sage: a = 3.14
            sage: type(a)                                                               # needs sage_libgap.rings.real_mpfr
            <... 'sage_libgap.rings.real_mpfr.RealLiteral'>
            sage: a.rename('pi')                                                        # needs sage_libgap.rings.real_mpfr
    ...
    def __repr__(self):
        ...
        super class (typically ``object``)::
            ...
            sage: from sage_libgap.structure.sage_object import SageObject
            sage: S = SageObject()
            sage: S
            <sage_libgap.structure.sage_object.SageObject object at ...>
        """
        try:
    ...
    def __hash__(self):
        ...
        EXAMPLES::
            ...
            Traceback (most recent call last):
            ...
            TypeError: <... 'sage_libgap.structure.sage_object.SageObject'> is not hashable
        """
    ...
    def _cache_key(self):
        ...
        in some computations::
            ...
            sage: # needs sage_libgap.rings.padics
            sage: K.<a> = Qq(9)
            sage: b = a + O(3)
            sage: c = a + 3
            sage: b
        ...
        ``_cache_key``::
            ...
            Traceback (most recent call last):
            ...
            TypeError: unhashable type: 'sage_libgap.rings.padics.qadic_flint_CR.qAdicCappedRelativeElement'
            sage: @cached_method
            ....: def f(x): return x==a
            sage: f(b)
            True
        ...
        the parent as its first argument::
            ...
            sage: S.<a> = Qq(4)                                                         # needs sage_libgap.rings.padics
            sage: d = a + O(2)                                                          # needs sage_libgap.rings.padics
            sage: b._cache_key() == d._cache_key()  # this would be True if the parents were not included               # needs sage_libgap.rings.padics
            False
    ...
    def dumps(self, compress=True):
        ...
        EXAMPLES::
            ...
            sage: from sage_libgap.misc.persist import comp
            sage: O = SageObject()
            sage: p_comp = O.dumps()
            ...
            sage: pickletools.dis(p_uncomp)
                0: \x80 PROTO      2
                2: c    GLOBAL     'sage_libgap.structure.sage_object SageObject'
               41: q    BINPUT     ...
               43: )    EMPTY_TUPLE
               44: \x81 NEWOBJ
               45: q    BINPUT     ...
