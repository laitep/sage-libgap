...
from sage_libgap.structure.sage_object cimport SageObject
...
cpdef inline parent(x) noexcept:
    ...
    EXAMPLES::
        ...
        Rational Field
        sage: c = 42.0
        sage: parent(c)                                                                 # needs sage_libgap.rings.real_mpfr
...
cpdef inline bint have_same_parent(left, right) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.structure.element import have_same_parent
        sage: have_same_parent(1, 3)
        True
        sage: have_same_parent(1, 1/2)
        False
        sage: have_same_parent(gap(1), gap(1/2))                                        # needs sage_libgap
        True
    ...
    These have different types but the same parent::
        ...
        sage: b = exp(a)
        sage: type(a)
        <... 'sage_libgap.rings.real_lazy.LazyWrapper'>
        sage: type(b)
        <... 'sage_libgap.rings.real_lazy.LazyNamedUnop'>
