...
cpdef inline richcmp_not_equal(x, y, int op) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.structure.richcmp import (richcmp_not_equal,
...
cpdef inline bint rich_to_bool(int op, int c) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.structure.richcmp import (rich_to_bool,
        ....:    op_EQ, op_NE, op_LT, op_LE, op_GT, op_GE)
        sage: for op in (op_LT, op_LE, op_EQ, op_NE, op_GT, op_GE):
        ....:     for c in (-1,0,1):
...
cpdef inline int revop(int op) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.structure.richcmp import revop
