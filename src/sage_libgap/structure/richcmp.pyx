...
of :class:`~sage_libgap.structure.element.Element`, ``x._richcmp_(y, op)``
...
from sage_libgap.cpython.wrapperdescr cimport get_slotdef, wrapperbase, PyDescr_NewWrapper
...
cpdef richcmp_item(x, y, int op) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.structure.richcmp import *
        sage: @richcmp_method
        ....: class Listcmp(list):
...
def richcmp_by_eq_and_lt(eq_attr, lt_attr):
    ...
    .. NOTE::
        ...
        in a class derived from :class:`sage_libgap.structure.element.Element`
        or a method ``__richcmp__`` in a class using
        :func:`richcmp_method`.

    EXAMPLES::

        sage: from sage_libgap.structure.richcmp import richcmp_by_eq_and_lt
    ...
    A simple example using ``richcmp_method``::
        ...
        sage: from sage_libgap.structure.richcmp import richcmp_method, richcmp_by_eq_and_lt
        sage: @richcmp_method
        ....: class C():
