...
import os
import warnings
import sage_libgap.env

from sage_libgap.gap_includes cimport *
from sage_libgap.cpython.string import FS_ENCODING
from sage_libgap.cpython.string cimport str_to_bytes, char_to_str
from sage_libgap.interfaces.gap_workspace import prepare_workspace_dir
...
cdef class ObjWrapper():
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.util import ObjWrapper
        sage: x = ObjWrapper()
        sage: y = ObjWrapper()
        sage: x == y
        True
...
cdef initialize() noexcept:
    ...
    argv[1] = "-A"
    argv[2] = "-l"
    s = str_to_bytes(sage_libgap.env.GAP_ROOT_PATHS, FS_ENCODING, "surrogateescape")
    argv[3] = s
    ...
    gap_mem = sage_libgap.env.SAGE_GAP_MEMORY
    ...
    from sage_libgap.saved_workspace import workspace
    ...
    if not workspace_is_up_to_date:
        ...
        from sage_libgap.misc.temporary_file import atomic_write
