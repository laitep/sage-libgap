...
from sage_libgap.cpython.string cimport bytes_to_str
...
cdef class AttributeErrorMessage:
    ...
    EXAMPLES::
        ...
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute 'bla'...
        sage: x = polygen(ZZ, 'x')
        sage: QQ[x].gen().bla                                                           # needs sage.libs.flint
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.polynomial.polynomial_rational_flint.Polynomial_rational_flint' object has no attribute 'bla'...

    ::

        sage: from sage_libgap.cpython.getattr import AttributeErrorMessage
    ...
    make a copy of its string representation before it changes. ::
        ...
        ....:     ElementError = exc
        sage: ElementError
        AttributeError('sage_libgap.rings.integer.Integer' object has no attribute '__bla'...)
        sage: try:
        ....:     x.__bla
        ....: except AttributeError as exc:
        ....:     ElementError2 = exc
        sage: ElementError
        AttributeError('sage_libgap.rings.polynomial...' object has no attribute '__bla'...)
        sage: ElementError2.args[0] is ElementError.args[0]
        True
        sage: isinstance(ElementError.args[0], sage_libgap.cpython.getattr.AttributeErrorMessage)
        True
...
cpdef getattr_from_other_class(self, cls, name) noexcept:
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.cpython.getattr import getattr_from_other_class
        sage: class A():
        ....:      def inc(self):
        ....:          return self + 1
        ....:
    ...
    :class:`Parent`::
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute 'lazy_attribute'...
    ...
    often do not accept to be cheated with the type of their instance::
        ...
        to ...'sage_libgap.rings.integer.Integer' object
    ...
    When this occurs, an :class:`AttributeError` is raised::
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute '__weakref__'...
    ...
    a workaround but there is no guarantee for robustness.
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute '__call__'...
    ...
    class, see :trac:`20686`::
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute '__name__'...
    ...
    Non-strings as "name" are handled gracefully::
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'sage_libgap.rings.integer.Integer' object has no attribute None...
    """
...
def dir_with_other_class(self, *cls):
    ...
    EXAMPLES::
        ...
        sage: x = A()
        sage: x.c = 1; x.e = 1
        sage: from sage_libgap.cpython.getattr import dir_with_other_class
    ...
    Check that :trac:`13043` is fixed::
        ...
        sage: len(dir(RIF))==len(set(dir(RIF)))                                         # needs sage_libgap.rings.real_interval_field
        True
    """
    ret = set()
