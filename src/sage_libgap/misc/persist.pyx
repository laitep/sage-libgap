...
from sage_libgap.misc.sage_unittest import TestSuite
...
#
# For a working example, see sage_libgap.rings.padics.lazy_template.LazyElement_unknown
already_pickled = { }
already_unpickled = { }
...
def load(*filename, compress=True, verbose=True, **kwargs):
    ...
    if lower.startswith("http://") or lower.startswith("https://"):
        from sage_libgap.misc.remote_file import get_remote_file
...
def register_unpickle_override(module, name, callable, call_name=None):
    ...
    :func:`~sage_libgap.misc.explain_pickle.explain_pickle` when called with ``in_current_sage=True``).)
    ...
    pickles essentially trying to do the following::
        ...
        sage: unpickle_global('sage_libgap.rings.old_integer', 'OldInteger')
        Traceback (most recent call last):
        ...
        ImportError: cannot import OldInteger from sage_libgap.rings.old_integer, call register_unpickle_override('sage_libgap.rings.old_integer', 'OldInteger', ...) to fix this

    After following the advice from the error message, unpickling
    works::

        sage: from sage_libgap.misc.persist import register_unpickle_override
        sage: register_unpickle_override('sage_libgap.rings.old_integer', 'OldInteger', Integer)
        sage: unpickle_global('sage_libgap.rings.old_integer', 'OldInteger')
        <... 'sage_libgap.rings.integer.Integer'>
    ...
    :class:`~sage_libgap.structure.element.Element`. This exact problem often arises
    ...
    :meth:`~sage_libgap.structure.element.Element.__setstate__` method from
    :class:`~sage_libgap.structure.element.Element` which is not compatible with
    ...
    :func:`~sage_libgap.misc.explain_pickle.explain_pickle`, which can help in figuring
    ...
    ::
        ...
        A(10)
        sage: sage_libgap.misc.explain_pickle.explain_pickle(dumps(A(10)))
        pg_A = unpickle_global('__main__', 'A')
        si = unpickle_newobj(pg_A, ())
        pg_make_integer = unpickle_global('sage_libgap.rings.integer', 'make_integer')
    ...
    :meth:`~sage_libgap.rings.integer.Integer.__reduce__` method from
    ...
    .. code-block:: cython
        ...
        def __reduce__(self):
            ...
            # if we don't do this.
            return sage_libgap.rings.integer.make_integer, (self.str(32),)
...
def unpickle_global(module, name):
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.misc.persist import unpickle_override, register_unpickle_override
        sage: unpickle_global('sage_libgap.rings.integer', 'Integer')
        <class 'sage_libgap.rings.integer.Integer'>

    Now we horribly break the pickling system::

        sage: register_unpickle_override('sage_libgap.rings.integer', 'Integer', Rational, call_name=('sage_libgap.rings.rational', 'Rational'))
        sage: unpickle_global('sage_libgap.rings.integer', 'Integer')
        <class 'sage_libgap.rings.rational.Rational'>

    and we reach into the internals and put it back::

        sage: del unpickle_override[('sage_libgap.rings.integer', 'Integer')]
        sage: unpickle_global('sage_libgap.rings.integer', 'Integer')
        <class 'sage_libgap.rings.integer.Integer'>
...
class _BasePickler(pickle.Pickler):
    ...
    :class:`sage_libgap.misc.persist.SagePickler`.
    ...
    def __init__(self, file_obj, protocol=None, persistent_id=None, *,
        ...
        def persistent_id(self, obj):
            ...
            :class:`sage_libgap.misc.persist.SagePickler` for more details.
            """
...
class _BaseUnpickler(pickle.Unpickler):
    """
    Provides the Python 3 implementation for
    :class:`sage_libgap.misc.persist.SageUnpickler`.
    ...
    def persistent_load(self, pid):
        ...
        See the documentation for :class:`sage_libgap.misc.persist.SageUnpickler`
        for more details.
        """
    ...
    def find_class(self, module, name):
        ...
        :func:`sage_libgap.misc.persist.unpickle_global`
        """
...
class SagePickler(_BasePickler):
    ...
    def dumps(cls, obj, **kwargs):
        ...
        - ``kwargs`` - keyword arguments passed to the
          :class:`sage_libgap.misc.persist.SagePickler` constructor.
        ...
        EXAMPLES::
            ...
            sage: import pickle
            sage: from sage_libgap.misc.persist import SagePickler
...
class SageUnpickler(_BaseUnpickler):
    ...
    ``sage_libgap.misc.persist.unpickle_global``.
    ...
    def loads(cls, data, **kwargs):
        ...
        - ``kwargs`` - keyword arguments passed to the
          :class:`sage_libgap.misc.persist.SageUnpickler` constructor.
        ...
        EXAMPLES::
            ...
            sage: import pickle
            sage: from sage_libgap.misc.persist import SageUnpickler
...
def picklejar(obj, dir=None):
    ...
    EXAMPLES::
        ...
        sage: dir = tmp_dir()
        sage: sage_libgap.misc.persist.picklejar(1, dir)
        sage: sage_libgap.misc.persist.picklejar('test', dir)
    ...
    Test an unaccessible directory::
        ...
        ....: else:
        ....:     try:
        ....:         sage_libgap.misc.persist.picklejar(1, dir + '/noaccess')
    ...
    """
    if dir is None:
        from sage_libgap.env import DOT_SAGE
...
def unpickle_all(target, debug=False, run_test_suite=False):
    ...
    EXAMPLES::
        ...
        sage: dir = tmp_dir()
        sage: sage_libgap.misc.persist.picklejar('hello', dir)
        sage: sage_libgap.misc.persist.unpickle_all(dir)
...
def make_None(*args, **kwds):
    ...
    EXAMPLES::
        ...
        sage: from sage_libgap.misc.persist import make_None
...
def db(name):
    ...
    """
    from sage_libgap.misc.misc import SAGE_DB
